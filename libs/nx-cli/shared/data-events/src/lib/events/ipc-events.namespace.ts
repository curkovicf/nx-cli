...
export namespace IpcEvents {
  export const isAngularProject: EventChannel = { fromAngular: 'CHECK_IS_ANGULAR_PROJECT', fromNode: 'CHECK_IS_ANGULAR_PROJECT_RESULT' };
  export const cleanup: EventChannel = { fromAngular: 'CLEANUP', fromNode: 'CLEANUP_RESULT' };
  export const installedPackages: EventChannel = { fromAngular: 'GET_INSTALLED_PACKAGES', fromNode: 'GET_INSTALLED_PACKAGES_RESULT' };
